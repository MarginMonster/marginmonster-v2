...
> = {
  dreamanime: {
    name: "Dream Anime",
    look: "soft painterly hand-drawn anime film style, watercolor-washed background, gentle warm sunlight, whimsical cozy detail, wholesome nostalgic wonder",
    motion: "gentle painterly anime motion, drifting petals and a soft breeze, slow warm camera pan, serene magical atmosphere",
    voice: "English_SereneWoman",
  },
  retroanime: {
    name: "Retro Anime",
    look: "1990s retro cel anime style, bold dramatic shading, subtle VHS grain, saturated sunset palette, nostalgic OVA aesthetic",
  ...
  pixar: {
    name: "3D Toon",
    look: "premium 3D animated-movie render, soft global illumination, glossy toy-like materials, rounded friendly forms, big-studio character-film look",
    motion: "smooth cinematic 3D camera drift, soft depth of field, gentle bouncy character-film motion",
    voice: "English_Trustworth_Man",
  },
  toyfigure: {
    name: "Boxed Figure",
    look: "collectible action-figure presentation: the product rendered as a glossy toy inside retail blister packaging on a printed cardboard backer, tiny accessories in molded compartments, studio toy-photography lighting",
  ...
  brick: {
    name: "Brick Build",
    look: "built entirely from glossy interlocking plastic toy bricks, chunky studded construction, bright primary colors, playful miniature brick-built world",
    motion: "playful stop-motion brick animation, snappy stepped movement, pieces clicking into place",
  ...
  clay: {
    name: "Claymation",
    look: "charming claymation-style render, hand-molded clay texture with subtle fingerprints, miniature stop-motion studio set, warm practical lighting",
