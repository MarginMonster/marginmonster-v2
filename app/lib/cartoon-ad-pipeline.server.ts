...
> = {
  ...
  brick: {
    name: "Brick Build",
    look: "built entirely from glossy interlocking plastic toy bricks: chunky studded construction, minifigure-scale proportions, bright saturated primary colors, crisp macro toy-photography focus, playful brick-built diorama world",
