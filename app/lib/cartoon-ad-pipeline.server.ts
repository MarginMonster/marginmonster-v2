...
> = {
  ...
  brick: {
    name: "Block Build",
    look: "built entirely from simple glossy plastic toy blocks: chunky smooth cube and rectangular construction, boxy squared-off character proportions with flat faces, bright saturated primary colors, crisp macro toy-photography focus, playful block-built voxel diorama world, an original generic toy-block aesthetic",
    motion: "playful stop-motion block animation, snappy stepped movement, blocks stacking and snapping into place",
