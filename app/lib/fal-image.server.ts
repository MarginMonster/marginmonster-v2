...
export async function submitCompose(
  ...
  const showcasePrompt =
    ...
    `The product sits in the LOWER HALF of the frame and takes up a good part of the width. The presenter is behind and above it, visible from the waist up, their head near the TOP EDGE of the frame with just a little headroom, whole face clearly visible with plenty of clear space between their chin and the top of the product — it never rises past their shoulders. ` +
