...
const EN: LandingCopy = {
  ...
  faq: {
    ...
    items: [
      { q: "How do tokens work?", a: "Your plan unlocks WHICH generators you can use (Starter: images & articles; Studio: + video; Anthem: everything). Tokens meter HOW MUCH you generate — every plan refills monthly, and you can top up any time. Tokens never unlock a generator your plan doesn't include." },
...
const ES: LandingCopy = {
  ...
  price: {
    ...
    tiers: {
      ...
      STUDIO: [
        "Todo lo de Starter",
        "Avatar AI — un presentador realista habla de tu producto",
        "Product Highlight — movimiento cinematográfico, sin presentador",
        "Campaign Autopilot — un mes de contenido, lanzado por ti",
      ],
      ANTHEM: [
        "Todo lo de Studio",
        "Anthem — tu avatar canta el tema musical de tu producto",
        "Los 8 estilos de Avatar Cartoon (anime, 3D, voxel y más)",
        "Nuestra mayor asignación de tokens — el mejor valor",
      ],
    },
  },
  faq: {
    ...
    items: [
      { q: "¿Cómo funcionan los tokens?", a: "Tu plan desbloquea QUÉ generadores puedes usar (Starter: imágenes y artículos; Studio: + video; Anthem: todo). Los tokens miden CUÁNTO generas — cada plan se recarga mensualmente y puedes comprar más cuando quieras. Los tokens nunca desbloquean un generador que tu plan no incluye." },
...
const FR: LandingCopy = {
  ...
  price: {
    ...
    tiers: {
      ...
      STUDIO: [
        "Tout Starter",
        "Avatar AI — un présentateur réaliste présente votre produit",
        "Product Highlight — mouvement cinématique, sans présentateur",
        "Campaign Autopilot — un mois de contenu, lancé pour vous",
      ],
      ANTHEM: [
        "Tout Studio",
        "Anthem — votre avatar chante l'hymne de votre produit",
        "Les 8 styles d'Avatar Cartoon (anime, 3D, voxel et plus)",
        "Notre plus grande dotation de tokens — le meilleur rapport",
      ],
    },
  },
  faq: {
...
const DE: LandingCopy = {
  ...
  price: {
    ...
    tiers: {
      ...
      STUDIO: [
        "Alles aus Starter",
        "Avatar AI — ein realistischer Presenter stellt dein Produkt vor",
        "Product Highlight — filmische Bewegung, ohne Presenter",
        "Campaign Autopilot — ein Content-Monat, für dich gestartet",
      ],
      ANTHEM: [
        "Alles aus Studio",
        "Anthem — dein Avatar singt den Song zu deinem Produkt",
        "Alle 8 Cartoon-Avatar-Styles (Anime, 3D, Voxel u.v.m.)",
        "Unser größtes Token-Kontingent — bester Wert pro Generierung",
      ],
    },
  },
  faq: {
    ...
    items: [
      { q: "Wie funktionieren Tokens?", a: "Dein Plan schaltet frei, WELCHE Generatoren du nutzen kannst (Starter: Bilder & Artikel; Studio: + Video; Anthem: alles). Tokens messen, WIE VIEL du erzeugst — jeder Plan lädt monatlich auf, und du kannst jederzeit nachkaufen. Tokens schalten nie einen Generator frei, den dein Plan nicht enthält." },
...
const ZH: LandingCopy = {
  ...
  price: {
    ...
    tiers: {
      ...
      STUDIO: [
        "包含 Starter 全部功能",
        "Avatar AI — 逼真主播讲解你的产品",
        "Product Highlight — 电影感运镜，无需主播",
        "Campaign Autopilot — 整月内容，自动投放",
      ],
      ANTHEM: [
        "包含 Studio 全部功能",
        "Anthem — 你的头像演唱专属产品主题曲",
        "全部 8 种卡通头像风格（动漫、3D、方块等）",
        "最大代币额度 — 单次生成最划算",
      ],
    },
  },
  faq: {
    ...
    h2: "大家常问的。",
    items: [
      { q: "代币是怎么用的？", a: "套餐决定你能用哪些生成器（Starter：图片和文章；Studio：加视频；Anthem：全部）。代币决定你能生成多少 — 每月自动补充，也可随时充值。代币永远不能解锁套餐之外的生成器。" },
