        ...
        <main className="lz-hero">
          ...
          <div className="lz-heroshow">
            <video
              ...
              poster="/showcase/commercial-cover.jpg"
...
@media (prefers-reduced-motion: reduce){.lz-herovid{display:none}.lz-heroshow::after{content:"";display:block;aspect-ratio:9/16;border-radius:22px;background:url('/showcase/commercial-cover.jpg') center/cover;}}
