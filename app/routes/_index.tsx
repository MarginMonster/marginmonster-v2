...
@media (prefers-reduced-motion: reduce){.lz-herovid{display:none}.lz-flank{display:none}.lz-heroshow::after{content:"";display:block;aspect-ratio:9/16;border-radius:22px;background:url('/showcase/hero-cut-cover.jpg?v=1') center/cover;}}
