      ...
      <div className="lz">
        ...
        <main className="lz-hero">
          ...
          <div className="lz-heroshow">
            ...
            />
            <span className="lz-herotag">▶ Real output — a full commercial, generated &amp; voiced by EasyMode</span>
          </div>

          <div className="lz-stats">
            <div><b>6</b><span>{t.stats.types}</span></div>
...
@media (prefers-reduced-motion: reduce){.lz-herovid{display:none}.lz-heroshow::after{content:"";display:block;aspect-ratio:9/16;border-radius:22px;background:url('/showcase/commercial-cover.jpg?v=2') center/cover;}}
